...
```
$ make
$ docker tag quay.io/kiegroup/kogito-operator:2540.0.0-snapshot quay.io/{USERNAME}/kogito-operator:2540.0.0-snapshot
$ docker push quay.io/{USERNAME}/kogito-operator:2540.0.0-snapshot
