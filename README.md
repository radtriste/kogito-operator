...
```
$ make
$ docker tag quay.io/kiegroup/kogito-operator:345.0.3-snapshot quay.io/{USERNAME}/kogito-operator:345.0.3-snapshot
$ docker push quay.io/{USERNAME}/kogito-operator:345.0.3-snapshot
